...
const PermisB = () => {
    ...
    const permisBHeader = pagesHeadersArray.find(el => el.title === '6')
    const permisBHeaderArray = []
    permisBHeaderArray.push(permisBHeader)

    return (
        <>
            <Helmet>
                <title>safbuddy.com - programme - permis B</title>
                <meta 
                    name='description'
                    content='Page personnalisée du programme permis B du site safbuddy.com' 
                />
                <link rel='canonical' href='https://www.safbuddy.com/PermisB' />
            </Helmet>
            <section id='permisB' className='permisB title-container-background'>
                {permisBHeaderArray.map((item, index) => (
                    <PagesHeaders 
                        key={index}
                            ...
                            <>
                                <div className='programme-containt'>
                                    <section className='programme'>
                                        ...
                                        <p className='mb-1l'>
                                        Atteindre et valider les compétences du programme de formation du permis B,
                                        ...
                                        <li>Compétence&nbsp;2 : appréhender la route et circuler dans les conditions normales</li>
                                        ...
                                        <li>
                                            Épreuve pratique de l’examen du permis B&nbsp;: à l’issue de la formation, selon les places attribuées
                                        ...
                                        <ul className='list mb-2l'>
                                        <li>Obligation légale&nbsp;: 20&nbsp;h de formation théorique et 20&nbsp;h de formation pratique</li>
                                        <li>
